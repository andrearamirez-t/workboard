    ...
    <footer className="mt-auto px-6 py-8">
      <div className="max-w-6xl mx-auto">
        <div className="h-px mb-6"
          style={{ background: "linear-gradient(90deg, transparent, oklch(0.52 0.13 165 / 30%), oklch(0.58 0.16 295 / 22%), transparent)" }} />
          ...
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-lg flex items-center justify-center text-white text-[11px] font-bold select-none"
              style={{
                ...
                boxShadow: "0 2px 8px oklch(0.52 0.13 165 / 30%)",
              }}>
              W
            </div>
